...
/* #cs-content *,#cs-content *:before,#cs-content *:after {
...
x-social-global.x-social-global-img {
    display: block;
  }
  .x-colophon.bottom .x-social-global.x-social-global-img a {
...
@media (max-width:979px) {
    .cabang-footer.cabang-v2 .phone span{
      border-right: none
    }
    .download-footer .text-download{
    ...
    .hasTop .x-nav-wrap.mobile.collapse.in {
      height: calc(100vh - 80px);
    }

    .x-nav-wrap.mobile.collapse.in ul.x-nav {
      padding: 0 25px;
    }

    .x-nav-wrap.mobile.collapse.in .close-nav {
      padding: 0 25px;
    }

    .x-menu-item.x-menu-item-login.reglog ul.x-nav {
      padding: 0 !important;
    }

    li.x-menu-item.x-menu-item-login.reglog ul .daftar a,
    li.x-menu-item.x-menu-item-login.reglog ul .remasuk a,
    li.x-menu-item.x-menu-item-login.reglog .sudah {
      margin-top: 25px;
      text-align: center;
      text-transform: uppercase;
    }

    li.x-menu-item.x-menu-item-login.reglog {
      padding-top: 25px;
      margin-bottom: 65px;
    }
  }
...
.main-banner-download {
  ...
  .gallery-menu-btn .button.button-galery{
    padding: 1em 1em;
    background: #fff;
    color: #54BB47;
    overflow: hidden;
    border: 1px solid #54BB47;
  ...
  .bg-gallery-page .x-container{
    max-width: 1220px;
  }
  .gallery-menu-btn .button.button-galery:hover,  .gallery-menu-btn .button.button-galery.active{
    background: #54BB47;
    color: white;
  }
  .bg-gallery-page{
  ...
  @media (max-width: 767px) {
    ...
    .main-banner-download.d-none{
      display: none;
    }
    .main-banner-download .banner-container {
      display: flex;
      align-items: center;
    ...
    .main-banner-download .banner-container p {
      margin-bottom: 0;
      padding-right: 15px;
      display: -webkit-box;
      -webkit-line-clamp: 2;
    ...
    .main-banner-download .close-banner-button {
      cursor: pointer;
      margin-right: 15px;
    }
  ...
  ul#menu-services-1, ul#menu-services {
    display: none;
}
  .x-brand {
  ...
  #menu-menu-footer-v2-1 li:nth-last-child(3),  #menu-menu-footer-v2 li:nth-last-child(3){
    margin-top: 40px;
  }
  a.store-btn.with-qr{
    padding: 15px;
  }
  .download-app-qr .with-qr img{
    max-width: 100px !important;
  }
  .download-app-qr .with-qr img.qr{
  ...
  .x-colophon.bottom .foot-menu .x-nav li {
    display: block;
  }
  ...
  #cs-content h2.h-custom-headline,
  h2,
  ...
  #cs-content h3.h-custom-headline,
  h3 {
    letter-spacing: 0.7px;
    /* font-size: 32px; */
    /* line-height: 41.6px; */
  ...
  #cs-content h4.h-custom-headline,
  h4,
  h5,
...
#cs-content .x-column {
  ...
  li.x-menu-item.x-menu-item-login.reglog ul .remasuk,
  li.x-menu-item.x-menu-item-login.reglog .sudah {
    background: #b1ebc6;
  }

  li.x-menu-item.x-menu-item-login.reglog ul .daftar {
    background: #00b451;
  }
  ...
  li.x-menu-item.x-menu-item-login.reglog ul .remasuk a i {
    display: none
  }
  ...
  .x-colophon.bottom .foot-menu .x-nav li a {
    font-weight: normal;
    margin-bottom: 25px;
  ...
  .download-footer.download-foot-v2 {
    text-align: left;
  }

  .download-footer.download-foot-v2 .download-app.foot {
    display: flex;
    margin: 0 -10px;
  }

  .download-footer.download-foot-v2 .text-download {
    margin-left: 0;
    color: #fcfcfc;
    font-size: 14px;
    font-weight: lighter;
  ...
  .download-footer.download-foot-v2 .download-app.foot img {
    margin: 0;
    width: auto;
    height: 31px;
    object-fit: contain;
  ...
  .download-footer.download-foot-v2 .download-app.foot a {
    display: inline-block;
    padding: 10px 15px;
    background: #004d43;
    margin: 0 10px;
  ...
  .cabang-footer.cabang-v2 .whatsapp-footer {
    position: relative;
    padding-left: 0px; 
    text-decoration: underline;
    background: transparent;
  ...
  #cs-content.cs-content .x-prompt {
    border-right: none;
    border-left: none;
    box-shadow: none;
    display: flex;
  ...
  #cs-content.cs-content .h-prompt {
    font-size: 33px;
    margin-bottom: 25px;
  }

  #cs-content.cs-content .x-prompt .x-prompt-section.x-prompt-section-message {
    width: 100%;
  }

  #cs-content.cs-content .x-prompt .x-prompt-section.x-prompt-section-button {
    max-width: 400px;
    width: 100%;
  }

  .gallery-menu-btn .button--nina {
    color: #03b450;
    text-shadow: none;
    border-color: #03b450;
    margin: 0.7vw;
  ...
  #post-49407 .hall-gal,
  #post-38105 .prog-gal,
  #post-37987 .event-gal,
  #post-38008 .vid-gal,
  #post-67114 .all-gal,
  #post-67085 .hall-gal,
  #post-67076 .prog-gal,
  #post-67043 .event-gal,
  #post-67071 .vid-gal,
  .gallery-menu-btn .button--nina:hover {
    background: #014d43;
    border-color: #014d43;
    color: white;
  }
  ...
  .cabang-footer .cabang-container{
  ...
  .download-app-qr .with-qr div:nth-child(1){
    width: 110px;
  }
  ...
  @media (min-width: 980px) {
    ...
    .x-navbar .desktop .x-nav>.current-menu-item>a {
      box-shadow: inset 0 -4px 0 0 rgb(0 166 2);
    }
    ...
    .search-brand a.x-btn-navbar-search {
      height: 85px;
      padding-left: 20px;
      display: inline-block;
      color: black;
  ...
  @media (max-width:979px) {
    ...
    li.x-menu-item.x-menu-item-login.reglog ul .daftar a, li.x-menu-item.x-menu-item-login.reglog ul .remasuk a, li.x-menu-item.x-menu-item-login.reglog .sudah {
        color: white !important;
    }
    li.x-menu-item.x-menu-item-login.reglog {
      padding-top: 25px;
  ...
  .popup .content span, .popup .content .text-countdown{
    display: block;
    position: absolute;
    bottom: 16%;
    right: 27%;
  ...
  .popup .content span.text-daftar, .popup .content .text-countdown{
    font-size: 132px;
    width: 100%;
    background: transparent;
    left: 0;
  ...
  .popup .content .text-countdown{
    padding-bottom: 15px;
    text-indent: 0px;
  }
  .popup .content .cal-countdown{
    width: 100%;
    max-width: 940px;
    margin: 0 auto;
    display: flex;
  }
  .popup .content .text-countdown .dlabel{
    color: #9EA1A4;
    font-weight: 300;
    letter-spacing: 1px;
    font-size: 20px;
  ...
  .popup .content .text-countdown .dtext{
    text-align: center;
    font-size: 92px;
    color: #fcfcfc;
    margin: 0;
  ...
  .popup .content .text-countdown .dcont{
    line-height: 1;
    width: 100%;
  }

  .popup .content .text-countdown .bgn{
    text-align: left;
    font-weight: 500;
    font-size: 24px;
    letter-spacing: 1px;
  ...
  .popup .content .text-countdown .dcol{
    letter-spacing: 0px;
    font-size: 92px;
    line-height: 1.2;
  }
  ...
  @media (max-width: 1080px) {
    .popup .content span.text-daftar{
      letter-spacing: 6vw;
      display: block;
      font-size: 11vw;
      bottom: 7%;
  ...
  .countdown-container-mobile-timer{
    ...
    .error-message{
        ...
        .stroke-white,.stroke-green,.stroke-green-l,.stroke-black{
            fill:none;
        ...
        @media (max-width:767px){
            ...
            .dw-btn{padding:10px 30px;}
            #modal-background2{display:none;width:50% !important;height:50% !important;
            }#modal{position:fixed !important;width:90% !important;}
            input.form-control{padding:20px;}
            h5.modal-title{margin:0;padding:20px 0;}
            .modal-header{width:100% !important;}
            h3.mobiledownload{text-align:left !important;}
            img.mobileplayapp{margin:0;width:100%;}
            h3 span{font-size:32px !important;}
            h3.h-custom-headline.mobilejdlh3 span{font-size:24px !important;font-family:"Lato",reguler;}
            .mobilejdlh4 {
                font-size:24px;
            ...
            span.mobilecalender{font-size:18px !important;}
            span.jdlmbl{font-size:20px !important;font-weight:bold !important;}
            div#x-section-2{display:block !important;background-image:none !important;padding:0px !important;}
            .never{text-align:left !important;padding:0 20px;}
            .imagebg2{display:block !important;}
            .x-container.cs-hide-lg.cs-hide-md.cs-hide-xl.max.width{
                background-image:url(https://tradersfamily.id/wp-content/uploads/2022/10/background-atas-2.png);
                width:100% !important;
            }
            div#x-section-1{
            ...
            .x-container.flex-deks.max.width{
                width:100% !important;
                background-image:url(https://tradersfamily.id/wp-content/uploads/2022/10/bg-atas-1.png);
            ...
            .just-days-bandung,.just-hours-bandung,.just-minutes-bandung,.just-seconds-bandung,.days-bandung,.hours-bandung,.minutes-bandung,.seconds-bandung,.days-jakarta,.hours-jakarta,.minutes-jakarta,.seconds-jakarta,.days,.hours,.minutes,.seconds{font-size:52px !important;}
            .hours-container,.days-container,.minutes-container{margin:0px !important;}
            .just-hours-container,.just-days-container,.just-minutes-container,.just-seconds-container{margin:0px !important;}
            .x-btn-3{width:100% !important;}
            .countdown-container-mobile-timer{display:flex !important;width:100%;justify-content:space-between;align-items:center;margin:15px 0;}
            .skh3{margin-bottom:20px !important;font-weight:500;}
            .x-column.x-sm.mobileReal.x-1-2{display:block;position:relative;left:0px !important;text-align:center;}
            .x-text.mobile{width:100% !important;}
            h3,.h3{font-size:150%;}
            .flex-mob{display:flex;padding-bottom:40px;align-items:center;}
            #cs-content .x-column.x-1-4{width:100% !important;}
            .position-text-img-hd{
                width:310px !important;
                margin:5px 0 !important;
            }
            /* .position-text-hd{font-size:18px !important;font-weight:lighter;padding:75px 20px !important;} */
            div#x-section-3{padding:30px 0 !important;}
            h3.h-custom-headline.t-shadow{margin-top:-15px !important;}
            .sk-no{
                color:#5ebb47;
                font-size:42px;
        ...
        .t-shadow{text-shadow:1px 1px 4px #686868;
        }
        ...
        #cs-content .with-container{border:0px solid rgba(0,0,0,0) !important;padding:5px;background-color:#fff;border-radius:0px !important;box-shadow:0 0px 0px 0 rgb(0 0 0 / 0%) !important;padding:0px !important;margin-bottom:-83px !important;background:transparent;}
        h3 span{
            font-size:32pt;
        }
        #cs-content .x-section.bg-image,#cs-content .x-section.bg-pattern{background-position:top right;}
        .x-btn-2{
            font-size:15px;
            background-color:#5ebb47;
        ...
        /* .days,.hours,.minutes,.seconds,.days-bandung,.hours-bandung,.minutes-bandung,.seconds-bandung,.days-jakarta,.hours-jakarta,.minutes-jakarta,.seconds-jakarta,.just-days-bandung,.just-hours-bandung,.just-minutes-bandung,.just-seconds-bandung{margin:0px;display:initial;font-size:5vw;color:white;font-weight:normal;} */
        .days,.hours,.minutes,.seconds,.days-bandung,.hours-bandung,.minutes-bandung,.seconds-bandung,.days-jakarta,.hours-jakarta,.minutes-jakarta,.seconds-jakarta{margin:0px;display:initial;font-size:100px;color:white;font-weight:normal;}
        .just-days-bandung,.just-hours-bandung,.just-minutes-bandung,.just-seconds-bandung{font-size:11vw !important;color:#5ebb47 !important;font-weight:bold !important;}
        .hours-container,.days-container,.minutes-container,.seconds-container{margin:0 20px;}
        .just-hours-container,.just-days-container,.just-minutes-container,.just-seconds-container{margin:0 20px;}
        .just-days-label,.just-hours-label,.just-minutes-label,.just-seconds-label{color:#4d4d4d;font-size:2vw;font-weight:bold;}
        /* .days-label,.hours-label,.minutes-label,.seconds-label{color:white;font-size:1.5vw;font-weight:bold;} */
        .days-label,.hours-label,.minutes-label{color:white;font-size:28px;}
        .countdown-container{display:flex;width:100%;justify-content:space-between;align-items:center;}
        .x-btn-3{
            font-size:15px;
        ...
        input.form-control,textarea.form-control{width:100% !important;background:transparent;border-radius:2px;padding:25px 20px;font-size:14px;color:#a5a5a5 !important;border-color:#a5a5a5 !important;}
        #modal-background,#modal-background2{display:none;background-color:rgba(0,0,0,0.2);position:fixed;top:0;left:0;width:100%;height:100%;z-index:1;}
        #modal{background-color:#fff;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:600px;padding:0px;border-radius:5px;display:flex;flex-direction:column;align-items:center;box-shadow:0 14px 28px rgba(0,0,0,0.25),0 10px 10px rgba(0,0,0,0.22);animation-name:animatemodal;animation-duration:0.4s;}
        .yes{border:none;padding:7px 14px;font-size:1.5rem;border-radius:5px;color:white;text-align:center;font-weight:bold;display:block;width:100%;background-color:#5ebb47;}
        input.form-control.pop-ipt-eml{width:550px !important;padding:20px;}
        #close-btn,#close-btn2{cursor:pointer;position:fixed;right:10px;top:10px;background-color:#939da4;padding:0px 6px;color:white;border:1px solid #939da4;border-radius:4px;}
        .modal-title,.modal-title2{margin:0;padding:20px 0;}
        .modal-header,.modal-header2{background-color:#e0e5e7;width:100%;text-align:left;padding:0 25px;}
        @keyframes animatemodal{from{top:-300px;opacity:0;}to{top:50%;opacity:1;}}
        a.x-btn.main-btn.x-btn-global:hover{background-color:transparent !important;border:1px solid green !important;}
        .imgdesktop{right:6em !important;}
        .x-column.x-sm.bg1.hide-mobile.x-1-2{right:-17vw !important;background-position:20px center !important;left:unset !important;}
        .btn-disable,.btn-disable:hover{background-color:#bbc1c5;color:#111820;cursor:not-allowed;}
        .flex-sect-cd{display:flex;flex-direction:column;justify-content:center;}
        a.next-section:hover{color:rgb(0,166,2);}
        .nonev-cus-h{height:35em;}
        .nonev-img-text{position:relative;width:22em;top:2em;left:4em;}
        .nonev-img-desktop{margin-top:1.02em !important;margin-left:0em !important;object-fit:contain;object-position:bottom;height:31.5em !important;}
        @media (min-width:1920px){
            .x-column.x-sm.bg1.hide-mobile.x-1-2{right:unset !important;left:unset !important;}
        }
        @media (max-width:767px){
            #cs-content .mt-35{margin-top:35px !important;}
            .countdown-container h1{font-size:58px;}
            .countdown-container span{display:inline-block;}
            .days-label,.hours-label,.minutes-label,.seconds-label{font-size:14px;}
            .info-pendaftaran-sec{padding:30px 0 !important;}
            .live-container{max-width:100%;}
            #modal p{padding:20px 20px 10px !important;}
            #modal .buttons{padding:10px 17px 25px !important;
            }.cus-colon{top:5px !important;}
            .nonev-cus-h{height:auto !important;}
            .nonev-img-text{width:13em !important;top:0em !important;left:0em !important;margin-bottom:0;}
            .pb-0{padding-bottom:0 !important;}
            .nonev-img-mobile{display:block !important;position:relative !important;object-fit:cover !important;float:right !important;top:0em !important;left:1.6em !important;margin-bottom:0 !important;}
            .nonev-img-desktop{display:none !important;}
            .just-days-label,.just-hours-label,.just-minutes-label,.just-seconds-label{font-size:12px !important;}
            .daftar-qna-sec{padding:35px 0 !important;}
            .x-btn-3{margin:25px 0 !important;}
            .footer-sect{padding:45px 0 !important;}
        }
        @media (min-width:2000px)
                {.days-label,.hours-label,.minutes-label,.seconds-label{font-size:30px !important;}
                .days,.hours,.minutes,.seconds,.days-bandung,.hours-bandung,.minutes-bandung,.seconds-bandung,.days-jakarta,.hours-jakarta,.minutes-jakarta,.seconds-jakarta,.just-days-bandung,.just-hours-bandung,.just-minutes-bandung,.just-seconds-bandung{
                    font-size:100px !important;}
                .cus-colon{font-size:5vw !important;}
        }
  ...
  .btn-footer-wa-lc a.btn-lcc img{
    width: 20px;
    margin-right: 10px;
  }
  
  .btn-footer-wa-lc a.btn-lcc .arrow{
    display: inherit;
    margin-left: 15px;
  }
  
  .btn-footer-wa-lc a.btn-lcc .flex-center{
    display: flex;
    align-items: center;
  }
  .x-container-footer .x-column {
    margin-right: 2%;
  }
  .x-navbar .desktop .x-nav > li > a:not(.x-btn-navbar-woocommerce) {
    padding-left: 15px;
...
.x-btn-navbar .x-icon-bars::before {
    content: url(data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%20fill%3D%22currentColor%22%20class%3D%22bi%20bi-list%22%20viewBox%3D%220%200%2016%2016%22%3E%0A%20%20%3Cpath%20fill-rule%3D%22evenodd%22%20d%3D%22M2.5%2012a.5.5%200%200%201%20.5-.5h10a.5.5%200%200%201%200%201H3a.5.5%200%200%201-.5-.5zm0-4a.5.5%200%200%201%20.5-.5h10a.5.5%200%200%201%200%201H3a.5.5%200%200%201-.5-.5zm0-4a.5.5%200%200%201%20.5-.5h10a.5.5%200%200%201%200%201H3a.5.5%200%200%201-.5-.5z%22%2F%3E%0A%3C%2Fsvg%3E);
}